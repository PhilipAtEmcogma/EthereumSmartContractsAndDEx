...
contract.skip("Dex",accounts =>{
    ...
    */
    ...
    //The BUY order book should be ordere on price from highest to lowest starting at index0
    it("The BUY order book should be ordered on price from highest to lowest starting at inde 0", async() => {
        //create instances
        let dex = await Dex.deployed()
        let link = await Link.deployed()

        await link.approve(dex.address, 500); //approve the contract for the link transfer
        await dex.depositEth({value: 3000});

        //create 3 mock limit orders
